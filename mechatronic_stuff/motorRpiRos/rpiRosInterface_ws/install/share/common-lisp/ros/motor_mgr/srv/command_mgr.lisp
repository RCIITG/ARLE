...
(cl:defmethod cl:initialize-instance :after ((m <command_mgr-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'command_mgr-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_mgr-srv:<command_mgr-request> is deprecated: use motor_mgr-srv:command_mgr-request instead.")))

(cl:ensure-generic-function 'motor_id-val :lambda-list '(m))
(cl:defmethod motor_id-val ((m <command_mgr-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_mgr-srv:motor_id-val is deprecated.  Use motor_mgr-srv:motor_id instead.")
  (motor_id m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <command_mgr-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_mgr-srv:command-val is deprecated.  Use motor_mgr-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<command_mgr-request>)))
  ...
  "7eed62a0c6b4eeb8dcfecd34103839c4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'command_mgr-request)))
  "Returns md5sum for a message object of type 'command_mgr-request"
  "7eed62a0c6b4eeb8dcfecd34103839c4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<command_mgr-request>)))
  ...
  (cl:format cl:nil "int32 motor_id~%string command~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'command_mgr-request)))
  "Returns full string definition for message of type 'command_mgr-request"
  (cl:format cl:nil "int32 motor_id~%string command~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <command_mgr-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'command_mgr-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_mgr-srv:<command_mgr-response> is deprecated: use motor_mgr-srv:command_mgr-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <command_mgr-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_mgr-srv:status-val is deprecated.  Use motor_mgr-srv:status instead.")
  (status m))
