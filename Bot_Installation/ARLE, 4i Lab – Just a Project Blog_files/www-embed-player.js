...
function b(t){for(var w=h,p=0;64>p;p+=4)w[p/4]=t[p]<<24|t[p+1]<<16|t[p+2]<<8|t[p+3];for(p=16;80>p;p++)t=w[p-3]^w[p-8]^w[p-14]^w[p-16],w[p]=(t<<1|t>>>31)&4294967295;t=e[0];var H=e[1],V=e[2],pa=e[3],xc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var La=pa^H&(V^pa);var Fb=1518500249}else La=H^V^pa,Fb=1859775393;else 60>p?(La=H&V|pa&(H|V),Fb=2400959708):(La=H^V^pa,Fb=3395469782);La=((t<<5|t>>>27)&4294967295)+La+xc+Fb+w[p]&4294967295;xc=pa;pa=V;V=(H<<30|H>>>2)&4294967295;H=t;t=La}e[0]=e[0]+t&4294967295;e[1]=
e[1]+H&4294967295;e[2]=e[2]+V&4294967295;e[3]=e[3]+pa&4294967295;e[4]=e[4]+xc&4294967295}
...
function Rh(){Sh().info.yt_lt="hot_bg";if(Th()){var a="hot_bg";Uh().info_yt_lt=a;if("yt_lt"in Lh){var b=Lh.yt_lt;0<=Ma(Nh,b)&&(a=!!a);"yt_lt"in Ph&&(a=Ph.yt_lt+a.toUpperCase());var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;Th()&&(vh(Sh().info,c),a=Vh(),b=Object.keys(c).join(""),th("info_"+b+"_"+a)||(c.clientActionNonce=a,qh("latencyActionInfo",c)))}else 0<=Ma(Mh,"yt_lt")||Q(Error("Unknown label yt_lt logged with GEL CSI."))}}
...
ri.prototype.m=function(){this.i=this.h=null;ri.A.m.call(this)};function si(a,b,c){I.call(this);this.f=a;this.i=c;this.j=U(window,"message",z(this.l,this));this.h=new ri(this,a,b);Xc(this,Ja(Yc,this.h))}
